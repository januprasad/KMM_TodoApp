package com.github.todo.presentation.screen.home
...
import com.github.todo.domain.RequestState
import com.github.todo.domain.TaskAction
import com.github.todo.domain.ToDoTask
import com.github.todo.presentation.screen.components.ErrorScreen
import com.github.todo.presentation.screen.components.LoadingScreen
import com.github.todo.presentation.screen.components.TaskView
import com.github.todo.presentation.screen.task.TaskScreen
...
fun DisplayTasks(
    ...
    Column(modifier = modifier.fillMaxWidth()) {
        ...
        tasks.DisplayResult(
            ...
            onSuccess = {
                if (it.isNotEmpty()) {
                    LazyColumn(modifier = Modifier.padding(horizontal = 24.dp, vertical = 10.dp)) {
                        items(
                            items = it,
